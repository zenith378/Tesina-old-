...
// Wed Sep 15 09:31:59 2021 by ROOT version 6.11/02
// from TTree Events/Events
// found on file: TTJets_SingleLeptFromT.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[181];   //[nGenPart]
   Float_t         GenPart_mass[181];   //[nGenPart]
   Float_t         GenPart_phi[181];   //[nGenPart]
   Float_t         GenPart_pt[181];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[181];   //[nGenPart]
   Int_t           GenPart_pdgId[181];   //[nGenPart]
   Int_t           GenPart_status[181];   //[nGenPart]
   Int_t           GenPart_statusFlags[181];   //[nGenPart]
   ...
   Float_t         Photon_mvaID_Spring16nonTrigV1[9];   //[nPhoton]
   ...
   Int_t           Photon_cutBased_Spring16V2p2[9];   //[nPhoton]
   ...
   Int_t           Photon_vidNestedWPBitmap_Spring16V2p2[9];   //[nPhoton]
   ...
   UInt_t          nSubJet;
   Float_t         SubJet_btagCMVA[11];   //[nSubJet]
   Float_t         SubJet_btagCSVV2[11];   //[nSubJet]
   Float_t         SubJet_btagDeepB[11];   //[nSubJet]
   Float_t         SubJet_eta[11];   //[nSubJet]
   Float_t         SubJet_mass[11];   //[nSubJet]
   Float_t         SubJet_n2b1[11];   //[nSubJet]
   Float_t         SubJet_n3b1[11];   //[nSubJet]
   Float_t         SubJet_phi[11];   //[nSubJet]
   Float_t         SubJet_pt[11];   //[nSubJet]
   Float_t         SubJet_rawFactor[11];   //[nSubJet]
   Float_t         SubJet_tau1[11];   //[nSubJet]
   Float_t         SubJet_tau2[11];   //[nSubJet]
   Float_t         SubJet_tau3[11];   //[nSubJet]
   Float_t         SubJet_tau4[11];   //[nSubJet]
   UInt_t          nTau;
   ...
   UChar_t         SubJet_nBHadrons[11];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[11];   //[nSubJet]
